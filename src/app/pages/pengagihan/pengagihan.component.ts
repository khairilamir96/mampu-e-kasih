...
@Component({
  selector: "app-pengagihan",
  templateUrl: "pengagihan.component.html"
})
export class PengagihanComponent implements OnInit, AfterViewInit {
  ...
  openModal4(template: TemplateRef<any>) {
    this.modalRef4 = this.modalService.show(template, { class: 'gray modal-lg' }); 
  }
  openModal5(template: TemplateRef<any>) {
    this.modalRef5 = this.modalService.show(template, { class: 'gray modal-lg' }); 
  }
  openModal6(template: TemplateRef<any>) {
    this.modalRef6 = this.modalService.show(template, { class: 'gray modal-lg' }); 
  }
  openModal7(template: TemplateRef<any>) {
    this.modalRef7 = this.modalService.show(template, { class: 'gray modal-lg' }); 
  }
  closeFirstModal() {
    if (!this.modalRef) {
      return;
